//checkscript.js(JavaScript forAnalyzer)
 ...
 // Check criteria
 var criteriaMet = password.match(/[A-Z]/) && password.match(/[a-z]/) &&
 password.match(/[0-9]/);
 criteriaBadge.textContent = criteriaMet ? "Meets criteria" : "Doesn't meet
 criteria";
